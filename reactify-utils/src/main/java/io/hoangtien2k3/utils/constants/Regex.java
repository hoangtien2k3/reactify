...
public class Regex {
    /**
     * Constant
     * <code>PHONE_REGEX="((\\+84|84|0)+(3|5|7|8|9|1|2[2|4|6|8|9]"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>EMAIL_REGEX="^(?![-_.@])[\\w.-]+(?&lt;![-_.@])@[a-zA"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>PASSWORD_REGEX="^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>DATE_FORMAT="^([0-2][0-9]|(3)[0-1])(\\/)(((0)[0-9])|"{trunked}</code>
     */
    ...
    /**
     * Constant
     * <code>VIETTEL_NUMBER_FORMAT="^8496\\d{7}$|^8497\\d{7}$|^8498\\d{7}$|"{trunked}</code>
     */
