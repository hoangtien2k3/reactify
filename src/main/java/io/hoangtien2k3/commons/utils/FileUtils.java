...
//    }
//
//    public static void createHash(SignPdfFile pdfSig, String certificate, String file) {
//        String folderRootCA = "./RootCA";
//        X509Certificate[] certChain = X509ExtensionUtil.getCertChainOfCert(certificate, folderRootCA);
//        String fontPath = "./font/times.ttf";
...
//    }
//
//    public static Boolean insertSignaturePdfFile(String signature, String destPath, String certificate, String file) {
//        SignPdfFile pdfSig = new SignPdfFile();
...
//    }
//
//    public static void getHashTypeRectangleText(SignPdfFile pdfSig, String filePath, X509Certificate[] certChain, String fontPath) {
